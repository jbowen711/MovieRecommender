const Home = () => {
    return(
        <>
            ...
            <p className="text-zinc-300 leading-relaxed max-w-2xl mx-auto px-4">
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur at blandit nulla. 
  Suspendisse nec sagittis erat. Nullam id felis ut nunc fermentum suscipit. Morbi non orci 
  eget lorem dapibus tempus. Donec mattis ante vel pulvinar fringilla. Ut condimentum nisl nec 
  sapien facilisis, ut semper odio sagittis. Pellentesque nec massa erat. Sed pulvinar eros ac 
  faucibus finibus. Nullam imperdiet, turpis ac luctus rhoncus, arcu magna malesuada ante, a 
  volutpat odio purus a neque.
